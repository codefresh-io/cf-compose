...
function validateExplicitlyExportedPorts(compositionObject) {
    ...
    var compositionExportsAnyExplicitPorts = _.any(collectedDeclarations, function (portDeclaration) {
...
function validateVolumes(compositionObject) {
    ...
    collectedDeclarations = _.flatten(collectedDeclarations, true);
    var localFilesystemVolumes = _.any(collectedDeclarations, function (volumeDeclaration) {
        var sourceVolume;
